...
vector *vector_create(copy_constructor_type copy_constructor,
    ...
    if (copy_constructor == NULL && destructor ==NULL && default_constructor ==NULL) {
        this->copy_constructor = shallow_copy_constructor;
        this->destructor = shallow_destructor;
        this->default_constructor = shallow_default_constructor;
    } else {
        if (this->copy_constructor ==NULL||this->destructor ==NULL||this->default_constructor == NULL) {
            free(this);
            return NULL;
        }
    ...
    this->array = calloc(INITIAL_CAPACITY, sizeof(void *));
    this->size = 0;
    return this;
}
...
void vector_reserve(vector *this, size_t n) {
    ...
    size_t newC = get_new_capacity(n);
    this->array = realloc(this->array,newC*sizeof(void *));
    this->capacity = newC;
}
...
void vector_set(vector *this, size_t position, void *element) {
    assert(this);
    void *tgt = vector_get(this, position);
    void **tochange = vector_at(this, position);
    *tochange = (this->copy_constructor)(element);
    (this->destructor)(tgt);
}
...
void vector_insert(vector *this, size_t position, void *element) {
    ...
    size_t i;
    for (i = position+1; i < vector_size(this); i++) {
        vector_set(this,i,this->array[i-1]);
    }
    vector_set(this,position,element);
    this->size++;*/
